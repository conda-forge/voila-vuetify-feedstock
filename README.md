...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/voila-vuetify-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7941&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/voila-vuetify-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `voila-vuetify` can be installed with:

```
conda install voila-vuetify
```

It is possible to list all of the versions of `voila-vuetify` available on your platform with:
